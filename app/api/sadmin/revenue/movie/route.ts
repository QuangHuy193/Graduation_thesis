...
// thống kê các doanh thu liên quan phim theo năm/tháng (cao nhất, thấp nhất)
export async function GET(req: Request) {
  try {
    ...
    console.error(error);
    return errorResponse("Lấy thông tin doanh thu phim thất bại", 500);
  }
}
