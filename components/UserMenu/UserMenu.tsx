                 ...
                 pointer-events-none group-hover:pointer-events-auto"
                            >
                                <LoadingLink href="/user-info" className={styles.InfoBtn}>
                                    <FontAwesomeIcon icon={faUser} className={styles.icon} /> Thông tin cá nhân
                                </LoadingLink>

                                {role === "admin" && (
                                    <LoadingLink href="/admin" className={styles.InfoBtn}>
                                        <FontAwesomeIcon icon={faBlackboard} className={styles.icon} /> Dashboard
                                    </LoadingLink>
                                )}

                                <button onClick={handleLogout} className={styles.logoutBtn}>
                                    <FontAwesomeIcon icon={faRightFromBracket} className={styles.icon} /> Đăng xuất
                                </button>
                            </div>
                        </div>
                    </span>
